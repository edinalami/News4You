...
public abstract class EspressoTest<T extends Activity> {
    ...
    public EspressoTest(Class<T> activityClass) {
        ...
        final AndroidTestNews4YouApplication application = (AndroidTestNews4YouApplication) InstrumentationRegistry.getInstrumentation()
                .getTargetContext()
                .getApplicationContext();
        injectDependencies((AndroidTestAppComponent) application.injector);
    }

    @BeforeClass
    public static void beforeClass() {
        InstrumentationRegistry.getInstrumentation().getTargetContext().deleteDatabase("news4you.db");
    }
    ...
    public abstract void injectDependencies(@NonNull final AndroidTestAppComponent appAndroidTestComponent);
